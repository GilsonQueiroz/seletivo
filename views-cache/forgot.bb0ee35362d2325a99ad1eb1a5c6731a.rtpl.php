                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Obrigado!</p>
                              <p class="body-signature"><img src="https://www.filepicker.io/api/file/2R9HpqboTPaB4NyF35xt" alt="Prefeitura Municipal de Rondon do Pará"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="#"><b>Click abaixo</b></a> se você tiver alguma dúvida ou sugestão
          </div>
        </td>
        <td></td>
      </tr>
