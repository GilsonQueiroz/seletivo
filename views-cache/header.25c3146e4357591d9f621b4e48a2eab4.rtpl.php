...
<head>
  ...
  <title>Rondon do Pará | Admin</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>PS - </b>PMRP</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Seletivo/</b>PMRP</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Cadastrar Edital</span>
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/admin/edital/files">Arquivos do Edital</a></li>
            <li><a href="/admin/edital/vagas">Vagas do Edital</a></li>
            <li><a href="#">Regras do Edital</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Gerenciar Edital</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="#">Mudar fase de Edital</a></li>
            <li><a href="#">Gerar resultados</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Configuração</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="/admin/cargo">Cadastrar funções</a></li>
